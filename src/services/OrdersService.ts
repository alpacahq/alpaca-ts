...
/* tslint:disable */
/* eslint-disable */
import type { CanceledOrderResponse } from "../models/CanceledOrderResponse.js";
import type { Order } from "../models/Order.js";
import type { PatchOrderRequest } from "../models/PatchOrderRequest.js";
...
export class OrdersService {
   ...
   * @throws ApiError
   */
  public deleteAllOrders(): CancelablePromise<Array<CanceledOrderResponse>> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/v2/orders",
      errors: {
