        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = parse).order;
                        return [4, this.request('GET', urls.rest.account, "orders/" + (params.order_id || params.client_order_id) + "?" + qs.stringify({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = parse).orders;
                        return [4, this.request('GET', urls.rest.account, "orders?" + qs.stringify(params))];
                    case 1: return [2, _b.apply(_a, [_c.sent()])];
                }
            });
        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4, this.request('GET', urls.rest.account, "account/activities" + (params.activity_type ? '/'.concat(params.activity_type) : '') + "?" + qs.stringify(params))];
                    case 1: return [2, _b.apply(_a, [_c.sent()])];
                }
            });
        });
...
//# sourceMappingURL=alpaca.esm.js.map
