...
var unifetch = typeof fetch !== 'undefined' ? fetch : isomorphic_unfetch_1.default;
var AlpacaClient = /** @class */ (function () {
    ...
    AlpacaClient.prototype.request = function (method, url, endpoint, data, isJson) {
        if (isJson === void 0) { isJson = true; }
        return __awaiter(this, void 0, void 0, function () {
            var headers, _i, _a, _b, key, value, makeCall, func, resp, result, e_1, e_2;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 5:
                        e_1 = _c.sent();
                        console.warn('Problem turning res to json', resp, e_1);
                        return [3 /*break*/, 6];
                    case 6:
                    ...
                    case 7:
                        e_2 = _c.sent();
                        console.warn('Error with fetch', e_2);
                        return [3 /*break*/, 8];
