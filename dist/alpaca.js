...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bottleneck'), require('qs'), require('ky-universal'), require('isomorphic-ws'), require('eventemitter3')) :
    typeof define === 'function' && define.amd ? define(['exports', 'bottleneck', 'qs', 'ky-universal', 'isomorphic-ws', 'eventemitter3'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.alpaca = {}, global.Bottleneck, global.qs, global.ky, global.WebSocket, global.EventEmitter));
}(this, (function (exports, Bottleneck, qs, ky, WebSocket, EventEmitter) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AlpacaClient = (function () {
        ...
        AlpacaClient.prototype.getBars = function (params) {
            ...
            return this.request('GET', urls.rest.market_data, "bars/" + params.timeframe + "?" + qs__default['default'].stringify(transformed));
        };
